...
public class ShopeePay extends Ewallet {
    ...
    public ShopeePay(User user, int saldo, int feeTopup, int feeTransfer, int feeWithdraw) {
        super(user, saldo);
    ...
    public ShopeePay(User user, int feeTopup, int feeTransfer, int feeWithdraw) {
        super(user);
        this.feeTopup = feeTopup;
        this.feeTransfer = feeTransfer;
        this.feeWithdraw = feeWithdraw;
