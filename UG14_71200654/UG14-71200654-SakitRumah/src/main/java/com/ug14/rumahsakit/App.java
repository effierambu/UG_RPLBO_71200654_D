...
/**
 * 71200654 Effie Rambu Boba
 *
 */
public class App 
{
    public static void main(String[] args, Pasien Pasien, int idPemeriksa, Boolean statusDaftar, Boolean statusScreening)
    {
        System.out.println("===========================================PROSES INISIALISASI============================================");
        System.out.println();
        Jadwal jadwal = new Jadwal(idPemeriksa, statusDaftar, statusScreening);
        ...
        Pasien pasien = pelayanan.registrasi(Pasien);
