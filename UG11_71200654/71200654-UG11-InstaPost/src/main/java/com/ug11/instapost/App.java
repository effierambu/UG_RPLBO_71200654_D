...
public class App 
{
    public static void main( String[] args ) throws EmailException{
        ...
        System.out.println("----------Skenario 2: Login Berhasil----------");
                instaPost.login("albertusadrian@gmail.com");
        System.out.println("----------Skenario 3: Posting Tanpa Mention----------");
                instaPost.post("Cuaca hari ini sangat baik.");
        System.out.println("----------Skenario 4: Posting dengan Mention #1----------");
                instaPost.post("Yuk gaes @nola @joyce makan di sini");
        System.out.println("----------Skenario 5: Posting dengan Mention #2----------");
                instaPost.post("@susi @dea @yossia Yuk kerjain tugas gaes");
        System.out.println("----------Skenario Final: Print Informasi Akun----------");
                instaPost.printInfo();
    }
    {
